...
import Alert from './upgradeModal.vue' // 引入vue模板
const upgradeModal = {} // 定义插件对象
upgradeModal.install = function(Vue, options) {
...
export default upgradeModal // 导出Toast（注意：此处不能用module exports导出，在一个文件中，不能同时使用require方式引入，而用module exports导出，两种方式不能混用）
